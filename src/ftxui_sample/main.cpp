...
// configuration step. It creates a namespace called `VkToy`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", VkToy::cmake::project_name, VkToy::cmake::project_version) };
